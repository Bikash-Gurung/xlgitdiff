// Updated main extension code
const vscode = require("vscode");
const excelUtils = require("./src/excel-utils");
const commonUtils = require("./src/common-utils");
const {
  compareExcelJson,
  getDifferencesSummary,
} = require("./src/diff-engine");

function activate(context) {
  const disposable = vscode.commands.registerCommand(
    "xldiff.diffxl",
    async () => {
      const excelFilePath = commonUtils.getCurrentExcelFilePath();
      if (excelFilePath) {
        ...
        const differences = compareExcelJson(currentJson, committedJson);
...
function getWebviewContent(currentData, committedData, differences, filePath) {
  ...
  console.log("removedSheets", removedSheets);
